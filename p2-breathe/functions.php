...
function breathe_scripts() {
	...
	wp_enqueue_script( 'breathe-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );

	wp_enqueue_script( 'breathe-mobile-helper', get_template_directory_uri() . '/js/mobile-helper.js', array(), '20130513', true );
	wp_enqueue_script( 'breathe-js', get_template_directory_uri() . '/js/breathe.js', array( 'breathe-mobile-helper', 'o2-enquire' ), '20130513', true );
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'breathe-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
	}
}
